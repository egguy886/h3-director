> This is the packaged copy. Asset paths were normalized to this folder; Picture numbering and ComfyUI node offsets are unchanged.
...
|---|---|---|
| `documentation` | `h3-director-pipeline.svg` | `assets/documentation/h3-director-pipeline.svg` |
| `documentation` | `h3-director-review-loop.svg` | `assets/documentation/h3-director-review-loop.svg` |
| `documentation` | `h3-episode-package.svg` | `assets/documentation/h3-episode-package.svg` |
